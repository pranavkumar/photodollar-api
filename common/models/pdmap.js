...
module.exports = function(Pdmap) {
    Pdmap.autocomplete = function (input, cb) {
        request({
    ...
    Pdmap.geocode = function (address, cb) {
        request({
    ...
    Pdmap.geocodeReverse = function (lat, lng) {
        let latlng = `${lat},${lng}`;
        console.log(latlng);
    ...
    Pdmap.remoteMethod('geocodeReverse', {
        accepts: [{
            arg: 'lat',
            type: 'number'
        },{
    ...
    Pdmap.remoteMethod('autocomplete', {
        accepts: [{
            arg: 'input',
            type: 'string'
        }],
